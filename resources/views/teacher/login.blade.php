...
<head>
    ...
    <style>
        * { font-family: 'Tajawal', sans-serif; box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .brand-circle img { width: 56px; height: 56px; object-fit: contain; }
...
<body>
    <div class="login-card">
        <div class="text-center mb-7">
            ...
            <p style="color: #9ca3af; margin-top: 0.25rem; font-size: 0.85rem;">بوابة المعلم</p>
        </div>
        ...
        @if(session('success'))
            <div style="background:#f0fdf4;border:1px solid #bbf7d0;color:#166534;padding:0.75rem 1rem;border-radius:12px;margin-bottom:1.25rem;display:flex;align-items:center;gap:0.5rem;font-size:0.85rem;">
        ...
        <div style="margin-top: 1.75rem; text-align: center; font-size: 0.8rem; color: #9ca3af; line-height: 1.8;">
            <i class="fas fa-info-circle" style="margin-left:0.25rem;"></i>
            هذه البوابة مخصصة للمعلمين المسجلين فقط.
            <br>
            <a href="{{ route('admin.login') }}" style="color: #823DBB; font-size: 0.75rem; font-weight: 600; text-decoration: none; display: inline-block; margin-top: 0.25rem;">
                دخول المسؤول
            </a>
        </div>
    </div>
